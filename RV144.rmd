...
The graph shows that 50% of people 18-30 years old who undergone vaccine and placebo are is not infected with HIV while the infected ones with Aids has 40% of vaccinated and 60% of people having placebo.
...
rowPerc(results)
```
This numerical explanation of the graph shows that people who had not infected by HIV-1 has approximately 99.38 and somehow 0.68 are partly does. while,people taking placebos,not infected got a perfectly 99.1 and 0.9 are the difference. Overall, the total of none-infected has the same result.They are not infected.However,the seconnd graph those infected with Aids who has none either vaccine and placebo one has 50.07  against the 49.93.On the other hand, 40.80 has aids with vaccine and 59.20 has placebos infected by HIV.The ones taking placebo have a higher result of infection.
...
<Summarise your results as to the effectiveness of the vaccine with explanations that could be understood by your mom>
 My conclusion, base on graphical and numerical result, People that are not infected yet with vaccine and placebo have the same result. they both have approximately 50-50 of the result. However the result of people with aids has the higher amount of counts. On Chi Square Test, the results showing that 3.9017 is the difference of infected ones from none infected ones. the p-value which is 0.0482.
